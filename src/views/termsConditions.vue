<template>
  <body>
    <h2><p><strong>Terms and Conditions</strong></p></h2>

    <p>Welcome to dipeat.com!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use of
      dipeat.com's Website, located at https://dipeat.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions. Do not
      continue to use dipeat.com if you do not agree to take all of the terms and
    ...
    <p>
      We employ the use of cookies. By accessing dipeat.com, you agreed to use cookies in
      agreement with the dipeat.com's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, dipeat.com and/or its licensors own the intellectual
      property rights for all material on dipeat.com. All intellectual property rights are
      reserved. You may access this from dipeat.com for your own personal use subjected to
    ...
    <p>
    <ul>
      <li>Republish material from dipeat.com</li>
      <li>Sell, rent or sub-license material from dipeat.com</li>
      <li>Reproduce, duplicate or copy material from dipeat.com</li>
      <li>Redistribute content from dipeat.com</li>
    </ul>
</p>

    <p>
      Parts of this website offer an opportunity for users to post and exchange opinions
      and information in certain areas of the website. dipeat.com does not filter, edit,
      publish or review Comments prior to their presence on the website. Comments do not
      reflect the views and opinions of dipeat.com,its agents and/or affiliates. Comments
      reflect the views and opinions of the person who post their views and opinions. To
      the extent permitted by applicable laws, dipeat.com shall not be liable for the
    ...
    <p>
      dipeat.com reserves the right to monitor all Comments and to remove any Comments
    ...
    <p>
      You hereby grant dipeat.com a non-exclusive license to use, reproduce, edit and
    ...
    <p>
      ...
      dipeat.com; and (d) the link is in the context of general resource information.
    </p>
    ...
    <p>
      ...
      in linking to our website, you must inform us by sending an e-mail to dipeat.com.
    ...
    <p>
      No use of dipeat.com's logo or other artwork will be allowed for linking absent a
